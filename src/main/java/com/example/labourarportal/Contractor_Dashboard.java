...
public class Contractor_Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card_updateStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(Contractor_Dashboard.this,UpdateContractorStatus.class);
        ...
        card_showRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(Contractor_Dashboard.this,ShowContractorRequestList.class);
                startActivity(intent);
            }
        });
